...
class ConfigurationTest extends \PHPUnit_Framework_TestCase
{
    public function testDefaults()
    {
        ...
        $this->assertEquals('sonata.payment.selector.simple', $config['selector']);
        $this->assertEquals('sonata.payment.generator.mysql', $config['generator']);
    ...
    public function validateTransformers($config)
    {
        ...
        $this->assertEquals('sonata.payment.transformer.order', $config['transformers']['order']);
        $this->assertEquals('sonata.payment.transformer.basket', $config['transformers']['basket']);
    }
}
